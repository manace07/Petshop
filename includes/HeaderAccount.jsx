                        ...
                        <div className="row">
                            <div className="col-12 d-flex align-items-center justify-content-between">
                                ...
                                <div className="header-logo">
                                    <div className="logo">
                                        <Link href="/"><img src="assets/images/logo/ds.png" alt="" /></Link>
                                    </div>
                                </div>
                                {/* End Header Logo */}
                                                    ...
                                                    <ul className="mega-menu-inner">
                                                        ...
                                                        <li className="mega-menu-item">
                                                            ...
                                                            <ul className="mega-menu-sub">
                                                                <li><Link to="/productfish">Fishes</Link></li>
                                                                <li><Link to="/productsffas">Fish Food and Aquarium Supplies</Link></li>
                                                                <li><Link to="/productdog">Dog Food and Accessories</Link></li>
                                                                <li><Link to="/productcat">Cat Food and Accessories</Link></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </div>
                        ...
                        <div className="mobile-header-left">
                            <ul className="mobile-menu-logo">
                                <li>
                                    <a href="index.html">
                                        <div className="logo">
                                            <img src="assets/images/logo/ds.png" alt="" />
                                        </div>
                                    </a>
                                </li>
                            </ul>
        ...
        <div id="offcanvas-wishlish" className="offcanvas offcanvas-rightside offcanvas-add-cart-section">
            ...
            <div className="offcanvas-wishlist-wrapper">
                ...
                <ul className="offcanvas-wishlist-action-button">
                    <li><Link to="/wishlist" className="btn btn-block btn-golden">View wishlist</Link></li>
                </ul>
            </div>
            {/* End Offcanvas Mobile Menu Wrapper */}
        </div>
